        ...
        <Container>
          ...
          <Paper elevation={3} sx={{ padding: 2, marginBottom: 4 }}>
            <Typography 
              ...
              color="#4a5d23" 
              textAlign="center"
              sx={{ marginBottom: 2, fontFamily: '"Lora", serif' }}
            >
          ...
          >
            ...
            >
              ...
              <TextField
                ...
                sx={{ marginBottom: 2 }}
              />
              <Button variant="contained" color="primary" onClick={() => { addItem(itemName); setItemName(""); handleClose(); }} sx={{ backgroundColor: '#a4c639', fontFamily: '"Roboto", sans-serif' }}>
                Add Item
              </Button>
            </Box>
          </Modal>
          <Button 
            ...
            sx={{
              backgroundColor: '#d6a4a4', // Muted red
              alignSelf: 'flex-end', 
              fontFamily: '"Roboto", sans-serif'
            }}
          >
